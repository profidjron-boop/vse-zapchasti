...
export const metadata: Metadata = {
  ...
  description:
    "Политика обработки персональных данных сайта «Все запчасти» (152-ФЗ).",
};
            ...
            <div className="space-y-8 text-neutral-700">
              <section>
                ...
                <p className="mt-3 leading-7">
                  Оператор: ИП Иванов Иван Иванович (ИНН 246500123456, ОГРНИП
                  321246800123456), сайт: vsezapchasti.ru. Политика действует в
