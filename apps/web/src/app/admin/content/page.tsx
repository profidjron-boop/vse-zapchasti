...
const PAGE_PRESETS: PagePreset[] = [
    ...
    blocks: [
      {
        key: "home_hero_title",
        type: "text",
        description: "Заголовок hero на главной",
        defaultValue: "Все запчасти и автосервис в одном месте",
      },
      {
        key: "home_hero_subtitle",
        type: "text",
        description: "Подзаголовок hero на главной",
        defaultValue:
          "Оригинальные запчасти и профессиональный ремонт легковых и грузовых автомобилей в Красноярске",
      },
      {
        key: "home_hero_cta_parts_label",
        type: "text",
        description: 'Текст кнопки CTA "Запчасти"',
        defaultValue: "Подобрать запчасти",
      },
      {
        key: "home_hero_cta_service_label",
        type: "text",
        description: 'Текст кнопки CTA "Сервис"',
        defaultValue: "Записаться на сервис",
      },
      {
        key: "home_order_parts_title",
        type: "text",
        description: 'Заголовок блока "Не нашли нужную запчасть?"',
        defaultValue: "Не нашли нужную запчасть?",
      },
      {
        key: "home_order_parts_subtitle",
        type: "text",
        description: 'Подзаголовок блока "Запчасти под заказ"',
        defaultValue: "Закажите обратный звонок — мы подберём и привезём",
      },
      {
        key: "home_order_parts_cta_label",
        type: "text",
        description: 'Текст CTA в блоке "Запчасти под заказ"',
        defaultValue: "Оставьте заявку",
      },
      {
        key: "home_contacts_address",
        type: "text",
        description: "Адрес в контактном блоке главной",
        defaultValue: "г. Красноярск, пр. Металлургов, 2В",
      },
      {
        key: "home_contacts_schedule",
        type: "text",
        description: "График в контактном блоке главной",
        defaultValue: "Пн–Пт 9:00–19:00, Сб 10:00–17:00, Вс выходной",
      },
      {
        key: "home_contacts_phone",
        type: "text",
        description: "Телефон в контактном блоке главной",
        defaultValue: "+7 (391) 258-95-00",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        type: "text",
        description: 'Адрес в блоке "Как нас найти"',
        defaultValue: "660000, г. Красноярск, пр. Металлургов, 2В",
      },
      {
        key: "contacts_schedule_weekdays",
        type: "text",
        description: "График Пн–Пт",
        defaultValue: "09:00 – 19:00",
      },
      {
        key: "contacts_schedule_saturday",
        type: "text",
        description: "График Сб",
        defaultValue: "10:00 – 17:00",
      },
      {
        key: "contacts_schedule_sunday",
        type: "text",
        description: "График Вс",
        defaultValue: "Выходной",
      },
      {
        key: "contacts_phone_parts",
        type: "text",
        description: "Телефон отдела запчастей",
        defaultValue: "+7 (391) 258-95-00",
      },
      {
        key: "contacts_phone_service",
        type: "text",
        description: "Телефон автосервиса",
        defaultValue: "+7 (391) 258-95-01",
      },
      {
        key: "contacts_phone_main",
        type: "text",
        description: "Телефон единой линии",
        defaultValue: "+7 (391) 258-95-00",
      },
      {
      ...
      },
      {
        ...
        type: "text",
        description: "Юр. наименование",
        defaultValue: "ИП Иванов Иван Иванович",
      },
      {
        key: "contacts_inn",
        type: "text",
        description: "ИНН",
        defaultValue: "246500123456",
      },
      {
        key: "contacts_ogrnip",
        type: "text",
        description: "ОГРНИП",
        defaultValue: "321246800123456",
      },
      {
        key: "contacts_legal_address",
        type: "text",
        description: "Юридический адрес",
        defaultValue: "660000, г. Красноярск, ул. Ленина, 1",
      },
      {
        key: "contacts_bank_account",
        type: "text",
        description: "Расчётный счёт",
        defaultValue: "40802810900001234567",
      },
      {
        key: "contacts_bank_name",
        type: "text",
        description: "Банк",
        defaultValue: "ПАО Сбербанк г. Красноярск",
      },
      {
        key: "contacts_bank_bik",
        type: "text",
        description: "БИК",
        defaultValue: "040407123",
      },
      {
        key: "contacts_map_yandex_url",
        type: "text",
    ...
    blocks: [
      {
        ...
        type: "text",
        description: "Заголовок hero на странице о компании",
        defaultValue: "О компании «Все запчасти»",
      },
      {
        key: "about_hero_subtitle",
        type: "text",
        description: "Подзаголовок hero на странице о компании",
        defaultValue:
      ...
      },
      {
        ...
        type: "text",
        description: 'Заголовок блока "Наша история"',
        defaultValue: "Наша история",
      },
      {
        key: "about_story_text",
        type: "html",
        description: 'Текст блока "Наша история" (HTML)',
        defaultValue: "",
      },
      {
        key: "about_values_title",
        type: "text",
        description: 'Заголовок блока "Наши принципы"',
        defaultValue: "Наши принципы",
      },
      {
        key: "about_values_text",
        type: "html",
        description: 'Текст блока "Наши принципы" (HTML)',
        defaultValue: "",
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        type: "text",
        description: "Дата обновления (подзаголовок)",
        defaultValue: "5 марта 2026 г.",
      },
      {
        key: "privacy_content_html",
        type: "html",
        description: "Основной HTML-контент политики",
        defaultValue: "",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        key: "offer_last_updated",
        type: "text",
        description: "Дата обновления (подзаголовок)",
        defaultValue: "5 марта 2026 г.",
      },
      {
        key: "offer_content_html",
        type: "html",
        description: "Основной HTML-контент оферты",
        defaultValue: "",
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        type: "text",
        description: "Заголовок hero на странице сервиса",
        defaultValue: "Автосервис в Красноярске",
      },
      {
        key: "service_hero_subtitle",
        type: "text",
        description: "Подзаголовок hero на странице сервиса",
        defaultValue: "Профессиональный ремонт и обслуживание автомобилей",
      },
      {
        key: "service_form_title",
        type: "text",
        description: "Заголовок формы сервиса",
        defaultValue: "Заявка на обслуживание",
      },
      {
        key: "service_form_subtitle",
        type: "text",
        description: "Подзаголовок формы сервиса",
        defaultValue:
          "Заполните форму — менеджер свяжется с вами для подтверждения",
      },
      {
        key: "service_success_title",
        type: "text",
        description: "Заголовок после успешной отправки формы",
        defaultValue: "Заявка отправлена!",
      },
      {
        key: "service_success_text",
        type: "text",
        description: "Текст после успешной отправки формы",
        defaultValue:
  ...
  },
  {
    ...
    blocks: [
      {
        key: "parts_hero_title",
        type: "text",
        description: "Заголовок страницы каталога",
        defaultValue: "Подбор запчастей",
      },
      {
        key: "parts_hero_subtitle",
        type: "text",
        description: "Подзаголовок страницы каталога",
        defaultValue:
          "Ищите по артикулу/OEM или названию. Если не уверены — оставьте VIN-заявку, менеджер подберёт совместимость.",
      },
      {
        key: "parts_search_label",
        type: "text",
        description: "Подпись поля поиска",
        defaultValue: "Поиск по артикулу или OEM",
      },
      {
        key: "parts_search_placeholder",
        type: "text",
        description: "Placeholder поля поиска",
        defaultValue: "Например: 06A905161B",
      },
      {
        key: "parts_short_query_message",
        type: "text",
        description: "Текст для слишком короткого запроса",
        defaultValue:
    ...
    blocks: [
      {
        key: "vin_hero_title",
        type: "text",
        description: "Заголовок hero на VIN-странице",
        defaultValue: "VIN-заявка",
      },
      {
        key: "vin_hero_subtitle",
        type: "text",
        description: "Подзаголовок hero на VIN-странице",
        defaultValue:
      ...
      },
      {
        key: "vin_form_title",
        type: "text",
        description: "Заголовок формы VIN-заявки",
        defaultValue: "VIN-номер *",
      },
      {
        key: "vin_form_submit_label",
        type: "text",
        description: "Текст кнопки отправки VIN-заявки",
        defaultValue: "Отправить заявку",
      },
      {
        key: "vin_success_title",
        type: "text",
        description: "Заголовок после успешной отправки VIN-заявки",
        defaultValue: "Заявка отправлена!",
      },
      {
        key: "vin_success_text",
        type: "text",
        description: "Текст после успешной отправки VIN-заявки",
        defaultValue:
    ...
    blocks: [
      {
        key: "cart_page_title",
        type: "text",
        description: "Заголовок страницы корзины",
        defaultValue: "Корзина",
      },
      {
        key: "cart_empty_text",
        type: "text",
        description: "Текст пустой корзины",
        defaultValue: "Ваша корзина пуста",
      },
      {
        key: "cart_go_to_catalog_label",
        type: "text",
        description: "Текст кнопки перехода в каталог",
        defaultValue: "Перейти в каталог",
      },
      {
        key: "cart_items_title",
        type: "text",
        description: "Заголовок блока списка товаров",
        defaultValue: "Товары",
      },
      {
        key: "cart_checkout_title",
        type: "text",
        description: "Заголовок блока оформления заказа",
    ...
    blocks: [
      {
        ...
        type: "text",
        description: "Заголовок страницы избранного",
        defaultValue: "Избранное",
      },
      {
        key: "favorites_clear_label",
        type: "text",
        description: "Кнопка очистки списка",
        defaultValue: "Очистить список",
      },
      {
        key: "favorites_empty_text",
        type: "text",
        description: "Текст пустого избранного",
        defaultValue: "Список избранного пока пуст.",
      },
      {
        key: "favorites_open_catalog_label",
        type: "text",
        description: "Кнопка перехода в каталог",
        defaultValue: "Открыть каталог",
      },
      {
        key: "favorites_open_product_label",
        type: "text",
        description: "Кнопка перехода к товару",
        defaultValue: "К товару",
      },
      {
        key: "favorites_add_to_cart_label",
        type: "text",
    ...
    blocks: [
      {
        ...
        defaultValue: "Мои заказы",
      },
      {
        key: "orders_page_subtitle",
        type: "text",
        description: "Подзаголовок страницы истории заказов",
        defaultValue:
          "Введите телефон, который указывали при оформлении заказа, чтобы посмотреть историю и статусы.",
      },
      {
        key: "orders_show_button_label",
        type: "text",
        description: "Текст кнопки поиска заказов",
        defaultValue: "Показать заказы",
      },
      {
        key: "orders_empty_text",
        type: "text",
        description: "Текст, когда заказы не найдены",
        defaultValue: "По этому номеру пока нет заказов.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "text",
        description: 'Пункт меню "Запчасти"',
        defaultValue: "Запчасти",
      },
      {
        key: "site_nav_service_label",
        type: "text",
        description: 'Пункт меню "Автосервис"',
        defaultValue: "Автосервис",
      },
      {
        key: "site_nav_contacts_label",
        type: "text",
        description: 'Пункт меню "Контакты"',
        defaultValue: "Контакты",
      },
      {
        key: "site_nav_about_label",
        type: "text",
        description: 'Пункт меню "О компании"',
        defaultValue: "О компании",
      },
      {
        key: "site_nav_favorites_label",
        type: "text",
        description: 'Пункт меню "Избранное"',
        defaultValue: "Избранное",
      },
      {
        key: "site_nav_cart_label",
        type: "text",
        description: 'Пункт меню "Корзина"',
        defaultValue: "Корзина",
      },
      {
        key: "site_nav_orders_label",
        type: "text",
        description: 'Пункт меню "Мои заказы"',
        defaultValue: "Мои заказы",
      },
      {
        ...
        defaultValue: "Все запчасти · Красноярск · NO CDN",
      },
      {
        key: "site_legal_privacy_label",
        type: "text",
        description: "Подпись ссылки на политику",
        defaultValue: "Политика конфиденциальности",
      },
      {
        key: "site_legal_offer_label",
        type: "text",
        description: "Подпись ссылки на оферту",
...
export default function ContentEditorPage() {
  ...
  async function handleCreateBlock() {
    ...
    try {
      ...
      setContent((prev) =>
        [...prev, createdBlock].sort((a, b) => a.key.localeCompare(b.key)),
      );
      setEditingValue((prev) => ({
        ...prev,
        [createdBlock.key]: createdBlock.value || "",
      }));
  ...
  async function handleCreatePresetBlocks(preset: PagePreset) {
    ...
    const missing = preset.blocks.filter(
  ...
  async function handleCreateAllPresetBlocks() {
    ...
    try {
      ...
      setSuccess(
        createdTotal > 0
          ? `Создано ключей: ${createdTotal}`
          : "Все ключи уже созданы",
      );
      setTimeout(() => setSuccess(""), 3000);
    } catch (createError) {
      if (isAuthError(createError)) return;
  ...
  async function handleSaveAllChanged() {
    const dirtyKeys = content
      .filter(
        (block) => (editingValue[block.key] || "") !== (block.value || ""),
      )
      .map((block) => block.key);
  ...
  const dirtyCount = content.filter(
    (block) => (editingValue[block.key] || "") !== (block.value || ""),
  ).length;
  ...
  const filteredContent = useMemo(() => {
    ...
    return content.filter((block) => {
      ...
      return (
        block.key.toLowerCase().includes(filter) || description.includes(filter)
      );
    });
  }, [content, keyFilter]);
  ...
  const existingKeys = new Set(content.map((block) => block.key));
  const totalPresetKeys = PAGE_PRESETS.reduce(
    (sum, preset) => sum + preset.blocks.length,
    0,
  );
  const totalMissingPresetKeys = PAGE_PRESETS.reduce(
    (sum, preset) =>
      sum +
      preset.blocks.filter((block) => !existingKeys.has(block.key)).length,
    0,
  );
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-[#1F3B73] mb-6">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3">
        ...
        >
          {savingAll
            ? "Сохранение..."
            : `Сохранить все изменения (${dirtyCount})`}
        </button>
        <span className="text-xs text-neutral-500">
          Несохранённых блоков: {dirtyCount}
        </span>
      </div>
      ...
      <div className="mb-6 min-h-[4.5rem]">
        {error ? (
          <div
            role="alert"
            aria-live="assertive"
            className="rounded-2xl bg-red-50 p-4 text-sm text-red-600 border border-red-200"
          >
            {error}
          </div>
        ) : null}
        {!error && success ? (
          <div
            role="status"
            aria-live="polite"
            className="rounded-2xl bg-green-50 p-4 text-sm text-green-600 border border-green-200"
          >
            {success}
          </div>
        ) : null}
      ...
      <div className="mb-6 rounded-2xl border border-neutral-200 bg-white p-6">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-xs text-neutral-500">
            Всего пресет-ключей: {totalPresetKeys} · отсутствует:{" "}
            {totalMissingPresetKeys}
          </div>
          <button
            type="button"
          ...
          >
            {creatingAllPresets
              ...
              : "Создать недостающие ключи для всех страниц"}
          </button>
        </div>
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          {PAGE_PRESETS.map((preset) => {
            const missingCount = preset.blocks.filter(
              (block) => !existingKeys.has(block.key),
            ).length;
            return (
              <div
              ...
              >
                ...
                <button
                  ...
                  disabled={
                    creatingPresetRoute === preset.route || missingCount === 0
                  }
      ...
      <div className="space-y-6">
        {filteredContent.length > 0 && (
          <div className="rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-500">
            Показано: {pagedContent.length} из {filteredContent.length} ·
        ...
        {pagedContent.map((block) => (
          <div
            key={block.key}
            className="border border-neutral-200 rounded-2xl bg-white p-6"
          >
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              {pendingDeleteKey === block.key ? (
                ...
                <button
                  ...
                  disabled={
                    Boolean(savingKey) || savingAll || Boolean(uploadingKey)
                  }
      ...
      {filteredContent.length > 0 && (
        <div className="mt-4 flex items-center justify-between gap-3 rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm">
          <div className="text-neutral-500">
            Фильтр применяется ко всем контент-ключам.
          </div>
