...
export const metadata: Metadata = {
  ...
  description:
    "Публичная оферта сервиса «Все запчасти» для заказа товаров и услуг.",
};
            ...
            <div className="space-y-8 text-neutral-700">
              <section>
                ...
                <p className="mt-3 leading-7">
                  1.1. Продавец — ИП Иванов Иван Иванович, осуществляющий
                  продажу товаров и услуг через сайт vsezapchasti.ru.
                  <br />
