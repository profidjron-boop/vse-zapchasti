...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_service_requests_uuid'), 'service_requests', ['uuid'], unique=True)
    ...
    op.create_index(op.f('ix_product_compatibility_id'), 'product_compatibility', ['id'], unique=False)
    op.create_index(op.f('ix_product_compatibility_make'), 'product_compatibility', ['make'], unique=False)
    op.create_index(op.f('ix_product_compatibility_model'), 'product_compatibility', ['model'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_product_compatibility_model'), table_name='product_compatibility')
    op.drop_index(op.f('ix_product_compatibility_make'), table_name='product_compatibility')
    op.drop_index(op.f('ix_product_compatibility_id'), table_name='product_compatibility')
