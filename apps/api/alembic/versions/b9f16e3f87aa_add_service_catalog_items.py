...
def upgrade() -> None:
    ...
    if not inspector.has_table("service_catalog_items"):
        op.create_table(
            ...
            sa.Column("vehicle_type", sa.String(length=20), nullable=False, server_default="passenger"),
    ...
    _ensure_index("service_catalog_items", op.f("ix_service_catalog_items_vehicle_type"), ["vehicle_type"])


def downgrade() -> None:
    """Downgrade schema."""
    _drop_index_if_exists("service_catalog_items", op.f("ix_service_catalog_items_vehicle_type"))
